...
export function renderReviewerApplicationConfirmation(
  ...
  const bodyHtml = [
    ...
    paragraph(
      `Our reviewers are central to the journal's scholarly integrity. While you wait to hear back, you may wish to revisit our Guide for Reviewers.`
    ),
    cta(forReviewersUrl, 'Guide for Reviewers'),
    paragraph(
  ...
  const text =
    `Dear ${applicantName},\n\n` +
    `Thank you for your interest in reviewing for OSCRSJ. We have received your application and a member of the editorial office will respond within 14 days.\n\n` +
    `Our reviewers are central to the journal's scholarly integrity. While you wait to hear back, you may wish to revisit our Guide for Reviewers at ${forReviewersUrl}.\n\n` +
    `If anything about your application needs correcting, reply to this message and we will update your record.\n\n` +
