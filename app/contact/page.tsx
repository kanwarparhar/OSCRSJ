        ...
        <div className="bg-white border border-border rounded-2xl p-8">
          ...
          <form className="space-y-5">
            ...
            <div>
              ...
              <select className="w-full text-sm px-4 py-2.5 bg-white border border-border rounded-lg focus:outline-none focus:border-peach focus:ring-1 focus:ring-peach/40 text-brown">
