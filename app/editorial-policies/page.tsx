...
export default function EditorialPoliciesPage() {
  return (
    <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="mb-10">
        <h1 className="font-serif text-3xl font-normal text-brown-dark">Editorial Policies</h1>
      ...
      <div className="space-y-10">
        ...
        <section>
          <h2 className="font-serif text-xl font-normal text-brown-dark mb-3">Publication Ethics</h2>
        ...
        <section>
          <h2 className="font-serif text-xl font-normal text-brown-dark mb-3">Patient Consent & Privacy</h2>
          <p className="text-tan leading-relaxed mb-3">
        ...
        <section>
          <h2 className="font-serif text-xl font-normal text-brown-dark mb-3">Authorship Criteria</h2>
          <p className="text-tan leading-relaxed mb-3">
          ...
          <p className="text-tan leading-relaxed mt-3">
        ...
        <section>
          <h2 className="font-serif text-xl font-normal text-brown-dark mb-3">Conflicts of Interest</h2>
          <p className="text-tan leading-relaxed mb-3">
        ...
        <section>
          <h2 className="font-serif text-xl font-normal text-brown-dark mb-3">Plagiarism & Originality</h2>
          <p className="text-tan leading-relaxed mb-3">
        ...
        <section>
          <h2 className="font-serif text-xl font-normal text-brown-dark mb-3">Corrections & Retractions</h2>
        ...
        <section>
          <h2 className="font-serif text-xl font-normal text-brown-dark mb-3">Authorship Disputes</h2>
          <p className="text-tan leading-relaxed mb-3">
        ...
        <section>
          <h2 className="font-serif text-xl font-normal text-brown-dark mb-3">Animal Research Ethics</h2>
          <p className="text-tan leading-relaxed">
        ...
        <section>
          <h2 className="font-serif text-xl font-normal text-brown-dark mb-3">Data Availability & Reproducibility</h2>
          <p className="text-tan leading-relaxed mb-3">
        ...
        <section>
          <h2 className="font-serif text-xl font-normal text-brown-dark mb-3">AI-Assisted Writing</h2>
          <p className="text-tan leading-relaxed">
