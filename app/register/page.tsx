  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="Create your OSCRSJ author account"
      />
      ...
      <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <section className="mb-12 bg-gradient-to-br from-tan/10 to-cream-alt border border-peach/20 rounded-2xl p-8 text-center">
          ...
          <h2 className="section-heading mb-3">Registration Opening Soon</h2>
        ...
        <section className="mb-12">
          ...
          <h2 className="section-heading mb-5 text-center">What You'll Get</h2>
