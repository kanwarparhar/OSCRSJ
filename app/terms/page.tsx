...
export default function TermsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-10">
        <h1 className="font-serif text-3xl font-semibold text-charcoal">Terms of Use</h1>
      ...
      <div className="space-y-8 text-sm text-charcoal-muted leading-relaxed">
        ...
        <section>
          <h2 className="font-serif text-xl font-semibold text-charcoal mb-3">Acceptance of Terms</h2>
          <p>
        ...
        <section>
          <h2 className="font-serif text-xl font-semibold text-charcoal mb-3">About OSCRSJ</h2>
          <p>
        ...
        <section>
          <h2 className="font-serif text-xl font-semibold text-charcoal mb-3">Copyright & Licensing</h2>
          <p className="mb-3">
        ...
        <section>
          <h2 className="font-serif text-xl font-semibold text-charcoal mb-3">Submissions & Peer Review</h2>
          <p className="mb-3">
        ...
        <section>
          <h2 className="font-serif text-xl font-semibold text-charcoal mb-3">Medical Disclaimer</h2>
          <p>
        ...
        <section>
          <h2 className="font-serif text-xl font-semibold text-charcoal mb-3">Website Use</h2>
        ...
        <section>
          <h2 className="font-serif text-xl font-semibold text-charcoal mb-3">Governing Law</h2>
          <p>
        ...
        <section>
          ...
          <p>
            ...
            <a href="mailto:legal@oscrsj.com" className="text-coral hover:text-coral-dark transition-colors font-medium">legal@oscrsj.com</a>.
          </p>
        </section>
      </div>
