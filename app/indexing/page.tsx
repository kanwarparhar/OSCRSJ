...
export default function IndexingPage() {
  return (
    <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="mb-10">
        <h1 className="font-serif text-3xl font-normal text-brown-dark">Indexing & Metrics</h1>
      ...
      <section className="mb-10 bg-gradient-to-br from-tan/10 to-cream-alt border border-peach/20 rounded-2xl p-8">
        <h2 className="font-serif text-xl font-normal text-brown-dark mb-3">Current Status</h2>
      ...
      <section className="mb-10">
        <h2 className="font-serif text-xl font-normal text-brown-dark mb-5">Indexing Roadmap</h2>
        <div className="space-y-3">
          {[
            ...
            <div key={item.title} className={`flex gap-4 border rounded-xl p-5 ${item.done ? 'bg-tan/10 border-peach/30' : 'bg-cream border-border'}`}>
              ...
              <div>
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <span className={`text-xs px-2 py-0.5 rounded-full ${item.done ? 'bg-tan/20 text-brown font-medium' : 'bg-cream-alt text-tan'}`}>
                    {item.status}
                  </span>
                </div>
      ...
      <section className="mb-10">
        <h2 className="font-serif text-xl font-normal text-brown-dark mb-5">Journal Metrics</h2>
      ...
      <section className="mb-10">
        <h2 className="font-serif text-xl font-normal text-brown-dark mb-3">Why Indexing Matters</h2>
        <p className="text-tan leading-relaxed">
