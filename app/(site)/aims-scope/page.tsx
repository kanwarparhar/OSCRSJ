      ...
      <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="prose-like space-y-8 text-sm leading-relaxed">
          ...
          <section className="mb-12">
            ...
            <p className="text-ink">
              All articles published in OSCRSJ are freely available to read, download, share, and adapt under a Creative Commons Attribution 4.0 International (CC BY 4.0) license, with attribution to the original authors. We do not charge readers or institutions for access. The journal is sustained through a flat article processing charge of $399 USD per accepted manuscript, payable only after acceptance and never a factor in editorial decisions. We believe that publicly relevant medical literature should be publicly accessible.
            </p>
          </section>
