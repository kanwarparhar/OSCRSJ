          ...
          <section>
            ...
            <ul className="space-y-2 pl-4 mb-3">
              {[
                ...
                'Anyone may read, download, share, and adapt published articles, including for commercial purposes',
                'Proper attribution to the original authors must be given, with a link to the license and an indication of any changes made',
                'Reuse for any purpose is permitted under these terms without seeking further permission from the authors or the journal',
              ].map((item) => (
