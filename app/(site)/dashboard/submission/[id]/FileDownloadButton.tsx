...
import { getAuthorFileSignedUrl } from '@/lib/submission/actions'

interface Props {
  fileId: string
}

export default function FileDownloadButton({ fileId }: Props) {
  ...
  function handleClick() {
    ...
    startTransition(async () => {
      const result = await getAuthorFileSignedUrl(fileId)
