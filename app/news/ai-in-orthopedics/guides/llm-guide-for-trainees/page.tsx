    ...
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="mt-12 bg-gradient-to-br from-tan/10 to-cream-alt border border-peach/20 rounded-2xl p-8 text-center">
        ...
        <p className="text-sm text-ink/80 leading-relaxed mb-5 max-w-lg mx-auto">
          OSCRSJ accepts case reports and series on novel AI-assisted diagnoses and surgical planning, with clear AI-disclosure policy. Full APC fee waiver for manuscripts submitted before July 1, 2026.
        </p>
