...
export default function AimsScopePage() {
  return (
    <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="mb-10">
        <h1 className="font-serif text-3xl font-normal text-brown-dark">Aims & Scope</h1>
      </div>

      <div className="prose-like space-y-8 text-sm text-tan leading-relaxed">

        <section>
          <h2 className="font-serif text-xl font-normal text-brown-dark mb-3">Purpose</h2>
          <p>
        ...
        <section>
          <h2 className="font-serif text-xl font-normal text-brown-dark mb-3">Subspecialties Covered</h2>
        ...
        <section>
          <h2 className="font-serif text-xl font-normal text-brown-dark mb-3">Target Audience</h2>
          <p>
        ...
        <section>
          <h2 className="font-serif text-xl font-normal text-brown-dark mb-3">Open Access Policy</h2>
          <p>
        ...
        <section>
          <h2 className="font-serif text-xl font-normal text-brown-dark mb-3">What We Do Not Publish</h2>
          <ul className="space-y-2 pl-4">
            {[
