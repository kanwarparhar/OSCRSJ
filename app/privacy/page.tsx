...
export default function PrivacyPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-10">
        <h1 className="font-serif text-3xl font-semibold text-charcoal">Privacy Policy</h1>
        <p className="text-charcoal-muted mt-2 text-lg">
          Last updated: April 2026
        </p>
      </div>

      <div className="space-y-8 text-sm text-charcoal-muted leading-relaxed">

        <section>
          <h2 className="font-serif text-xl font-semibold text-charcoal mb-3">Overview</h2>
          <p>
        ...
        <section>
          <h2 className="font-serif text-xl font-semibold text-charcoal mb-3">Information We Collect</h2>
        ...
        <section>
          <h2 className="font-serif text-xl font-semibold text-charcoal mb-3">How We Use Your Information</h2>
        ...
        <section>
          <h2 className="font-serif text-xl font-semibold text-charcoal mb-3">Data Retention</h2>
          <p>
        ...
        <section>
          <h2 className="font-serif text-xl font-semibold text-charcoal mb-3">Security</h2>
          <p>
        ...
        <section>
          <h2 className="font-serif text-xl font-semibold text-charcoal mb-3">Changes to This Policy</h2>
          <p>
        ...
        <section>
          <h2 className="font-serif text-xl font-semibold text-charcoal mb-3">Contact Us</h2>
          <p>
            If you have questions about this Privacy Policy or your personal data, please contact us at{' '}
            <a href="mailto:privacy@oscrsj.com" className="text-coral hover:text-coral-dark transition-colors font-medium">privacy@oscrsj.com</a>.
          </p>
        </section>
      </div>
