...
export default function EditorialBoardPage() {
  return (
    <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="mb-10">
        <h1 className="font-serif text-3xl font-normal text-brown-dark">Editorial Board</h1>
      ...
      <section className="mb-10">
        <h2 className="text-xs font-semibold text-tan uppercase tracking-widest mb-4">Editor-in-Chief</h2>
      ...
      {/* Associate Editors */}
      <section className="mb-10">
        <h2 className="text-xs font-semibold text-tan uppercase tracking-widest mb-4">Associate Editors</h2>
        <div className="grid sm:grid-cols-2 gap-4">
          {[
            'Trauma & Fractures', 'Sports Medicine', 'Spine', 'Arthroplasty',
            'Pediatric Orthopedics', 'Hand & Wrist', 'Foot & Ankle', 'Tumor & Oncology',
          ].map((specialty) => (
            <div key={specialty} className="bg-cream border border-border rounded-xl p-5 flex items-start gap-4">
      ...
      <div className="bg-gradient-to-br from-tan/10 to-cream-alt border border-peach/20 rounded-2xl p-8 text-center">
        <h2 className="font-serif text-xl font-normal text-brown-dark mb-2">Join Our Editorial Board</h2>
        <p className="text-tan text-sm mb-6 max-w-xl mx-auto">
