...
export default function PastIssuesPage() {
  return (
    <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="mb-10">
        <h1 className="font-serif text-3xl font-normal text-brown-dark">Past Issues</h1>
      ...
      <section className="mb-10 bg-cream-alt border border-border rounded-2xl p-8 text-center">
        ...
        <h2 className="font-serif text-xl font-normal text-brown-dark mb-3">No Past Issues Yet</h2>
        <p className="text-tan leading-relaxed max-w-lg mx-auto mb-2">
      ...
      <section className="mb-10">
        <h2 className="font-serif text-xl font-normal text-brown-dark mb-5">What to Expect</h2>
