...
// FLIP TRIGGER: remove the `robots` line below when V1 I1 ships.
      ...
      <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <section className="mb-12 bg-cream-alt border border-border rounded-2xl p-8 text-center">
          ...
          <p className="text-ink leading-relaxed mb-5 max-w-xl mx-auto">
            Publishing in a journal&apos;s inaugural issue is a unique opportunity. APCs are waived for all manuscripts submitted before July 1, 2026. Submit your case report or case series today.
          </p>
