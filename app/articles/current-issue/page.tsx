...
export default function CurrentIssuePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-10">
        <h1 className="font-serif text-3xl font-semibold text-charcoal">Current Issue</h1>
      ...
      <section className="mb-10 bg-gradient-to-br from-coral/10 to-sand border border-coral/20 rounded-2xl p-8">
        <h2 className="font-serif text-xl font-semibold text-charcoal mb-3">Inaugural Issue Coming Soon</h2>
      ...
      <section className="mb-10">
        <h2 className="font-serif text-xl font-semibold text-charcoal mb-5">Publication Timeline</h2>
        <div className="space-y-3">
          {[
            ...
            <div key={item.step} className={`flex gap-4 border rounded-xl p-5 ${item.active ? 'bg-coral/5 border-coral/30' : 'bg-white border-border'}`}>
              <span className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0 ${item.active ? 'bg-coral text-white' : 'bg-sand text-charcoal-muted'}`}>
                {item.step}
              </span>
              <div>
      ...
      <section className="mb-10 bg-sand border border-border rounded-2xl p-8 text-center">
        <h2 className="font-serif text-xl font-semibold text-charcoal mb-3">Be Part of Our First Issue</h2>
        <p className="text-charcoal-muted leading-relaxed mb-5 max-w-xl mx-auto">
