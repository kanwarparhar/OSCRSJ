...
// short. The server-side fetcher in page.tsx maps internal → descriptive
// before passing the array down to this client component.)
...
function ArticlesBrowserInner({ articles }: { articles: BrowserArticle[] }) {
              ...
              filtered.map((article) => (
                ...
                >
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    ...
                    <span className="text-sm text-brown italic">Full text available soon</span>
                  </div>
                </article>
              ))
            )}
...
export default function ArticlesBrowser({ articles }: { articles: BrowserArticle[] }) {
  // useSearchParams needs a Suspense boundary in Next 14 App Router.
  return (
    <Suspense fallback={<div />}>
      <ArticlesBrowserInner articles={articles} />
    </Suspense>
  )
}
