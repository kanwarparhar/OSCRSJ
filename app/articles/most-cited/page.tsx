...
export default function MostCitedPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-10">
        <h1 className="font-serif text-3xl font-semibold text-charcoal">Most Cited</h1>
      ...
      <section className="mb-10">
        <h2 className="font-serif text-xl font-semibold text-charcoal mb-5">About Citation Tracking</h2>
      ...
      <section className="mb-10">
        <h2 className="font-serif text-xl font-semibold text-charcoal mb-3">Why Citations Matter</h2>
